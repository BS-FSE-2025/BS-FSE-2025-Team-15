...
urlpatterns = [
    ...
    path('delete/<int:drug_id>/', pharmacy_drug_controller.delete_drug, name='delete_pharmacy_drug'),
    path('update/<int:drug_id>/', pharmacy_drug_controller.update_drug, name='update_pharmacy_drug'),
